...
- Verificación del cumplimiento de los requisitos funcionales y no funcionales definidos para el sistema AstraLog.
...
- Establecimiento de una línea base de calidad que sirva como referencia para futuras mejoras y versiones de AstraLog.

### 3.3 Riesgos que se Pretenden Mitigar

- Riesgo de incumplimiento de los requisitos funcionales y no funcionales definidos para el sistema AstraLog.
...
El análisis preliminar de la documentación del proyecto AstraLog permite identificar las siguientes situaciones que justifican la realización de la auditoría:
...
- Necesidad de identificar oportunidades de mejora que permitan fortalecer la calidad, mantenibilidad, rendimiento y confiabilidad del sistema AstraLog.

### 4.2 Oportunidad

La realización de esta auditoría representa una oportunidad para validar la calidad del sistema AstraLog, verificar el cumplimiento de las buenas prácticas de Ingeniería de Software aplicadas durante su desarrollo y fortalecer los procesos de gestión, control y aseguramiento de la calidad. Asimismo, permitirá identificar oportunidades de mejora que contribuyan a incrementar la confiabilidad, mantenibilidad y seguridad del sistema antes de futuras versiones o despliegues operativos.

## 5. Objetivo General

Realizar una auditoría formal del Ciclo de Vida del Desarrollo de Software (SDLC) del proyecto AstraLog, mediante la evaluación sistemática de sus procesos, controles, documentación, arquitectura y entregables, con el fin de determinar el grado de cumplimiento de los estándares ISO/IEC 12207, ISO/IEC 25010, CMMI-DEV y las buenas prácticas de Ingeniería de Software, identificar riesgos y oportunidades de mejora, y emitir recomendaciones que contribuyan a garantizar la calidad, seguridad, mantenibilidad y confiabilidad del sistema implementado para ASTRAMACO III.

## 6. Objetivos Específicos

- **OE1 – Metodología y Gestión del Proyecto:** Evaluar si el proyecto AstraLog fue planificado, ejecutado y controlado adecuadamente, verificando la aplicación de prácticas Scrum, CMMI, gestión de cambios, seguimiento de actividades y documentación del proyecto.
- **OE2 – Análisis de Requisitos:** Verificar que el proceso de levantamiento, documentación y validación de los requisitos funcionales y no funcionales del sistema AstraLog fue realizado de manera adecuada y cuenta con trazabilidad.
...
- **OE9 – Seguridad:** Verificar la efectividad de los mecanismos de autenticación, autorización, gestión de roles, protección de datos y trazabilidad implementados en AstraLog.
...
La auditoría SDLC del proyecto AstraLog abarcará las siguientes áreas y aspectos:
...
- Participación de los stakeholders de ASTRAMACO III en la identificación y validación de necesidades del negocio.
...
- Diseño del modelo de datos y su correspondencia con los procesos de negocio de ASTRAMACO III.
...
- Evidencia de validación y aceptación del sistema por parte de los stakeholders de ASTRAMACO III.
...
- La infraestructura física de hardware, redes y equipos utilizados por ASTRAMACO III.
- Los procesos operativos y administrativos de ASTRAMACO III que no estén directamente relacionados con el sistema AstraLog.
...
- **ISO/IEC 12207:2017 – Ciclo de Vida del Software:** Estándar internacional que establece los procesos para la gestión, desarrollo, operación y mantenimiento del software. Será utilizado para evaluar el cumplimiento de las actividades realizadas durante el ciclo de vida del sistema AstraLog.
- **ISO/IEC 25010 – Calidad del Producto de Software:** Modelo de calidad que define las características de adecuación funcional, eficiencia del desempeño, compatibilidad, usabilidad, fiabilidad, seguridad, mantenibilidad y portabilidad, las cuales servirán como referencia para evaluar la calidad del sistema AstraLog.
- **CMMI-DEV:** Modelo de madurez para el desarrollo de software, utilizado para evaluar la aplicación de buenas prácticas en la gestión de requisitos, planificación del proyecto, aseguramiento de la calidad, gestión de la configuración y mejora de los procesos implementados durante el desarrollo de AstraLog.
...
La auditoría SDLC del proyecto AstraLog – Solución Logística Centralizada se ejecutará siguiendo el procedimiento general de auditoría del Ciclo de Vida del Desarrollo de Software (SDLC), estructurado en cuatro fases:
...
- Definición de los criterios de auditoría con base en ISO/IEC 12207, ISO/IEC 25010, CMMI-DEV y el Checklist SDLC establecido para el proyecto AstraLog.
- Definición de los objetivos de la auditoría alineados con el presente Project Charter y las necesidades de ASTRAMACO III.
...
- Identificación del modelo SDLC utilizado durante el desarrollo del sistema AstraLog.
...
- Identificación de los roles y responsabilidades del equipo de desarrollo CoreSystems Solutions y de los representantes de ASTRAMACO III involucrados en el proyecto.
- Elaboración del Plan de Auditoría detallado.
- Elaboración del Checklist SDLC adaptado al contexto del sistema AstraLog.
- Comunicación formal del inicio de la auditoría al patrocinador y al equipo auditado.

**Entregables:** Plan de Auditoría, Checklist SDLC adaptado a AstraLog, Comunicación formal de inicio de la auditoría.
...
- Entrevistas al equipo de desarrollo (CoreSystems Solutions) para comprender cómo se ejecutó cada fase del Ciclo de Vida del Desarrollo de Software (SDLC), la aplicación de Scrum y las prácticas de calidad implementadas durante el proyecto.
...
- Documentación del estado actual de cada proceso del SDLC, identificando fortalezas, debilidades y oportunidades de mejora durante el desarrollo del sistema AstraLog.
...
- Evaluación de la evidencia recopilada frente a los criterios de auditoría establecidos (ISO/IEC 12207, ISO/IEC 25010, CMMI-DEV y Checklist SDLC), determinando el grado de cumplimiento de los objetivos de control definidos para el sistema AstraLog.
...
- Clasificación de los hallazgos según su nivel de criticidad e impacto para ASTRAMACO III, diferenciando entre hallazgos menores, significativos y críticos.
...
- Elaboración de la Matriz de Riesgos, identificando y evaluando los riesgos derivados de las brechas detectadas durante la auditoría, considerando aspectos relacionados con la calidad, seguridad, mantenibilidad y operación del sistema AstraLog.
...
- Revisión del Informe Preliminar con el equipo de desarrollo CoreSystems Solutions y los representantes de ASTRAMACO III, recopilando observaciones, comentarios y aclaraciones antes de emitir el informe definitivo.
- Elaboración del Informe Final de Auditoría, incorporando las observaciones recibidas, las conclusiones finales y las recomendaciones orientadas al fortalecimiento de los procesos de desarrollo, la calidad del software y la mejora continua del sistema AstraLog.
...
- Presentación del Informe Final de Auditoría al patrocinador, a los representantes de ASTRAMACO III y al equipo de desarrollo CoreSystems Solutions, exponiendo los hallazgos, conclusiones y recomendaciones obtenidas durante la auditoría.
- Elaboración del Plan de Acción Correctiva por parte del equipo auditado, definiendo las acciones necesarias para atender las no conformidades y oportunidades de mejora identificadas en el sistema AstraLog.
...
- Seguimiento a la implementación del Plan de Acción Correctiva, verificando el cumplimiento de las actividades, responsables y plazos establecidos para la mejora del sistema AstraLog.
...
*Nota: la fuente original de esta tabla identifica al entregable N.° 3 como "Checklist SDLC Adaptado" y su descripción menciona el contexto de "SYS PROFAR", nombre de un proyecto de plantilla del curso; en el contexto de este documento (AstraLog) se entiende referido al Checklist SDLC Adaptado a AstraLog.*
...
|---|---|---|
| Auditor líder — MAMANI VARGAS, Anthony Kelman | Dirección y coordinación | Emitir un informe objetivo, completo y fundamentado |
| Equipo Auditor — QUISPE QUISPE, Yunior Benito; RAMOS COAQUIRA, Jeimy Paul; APAZA YUCRA, Elvis Jesús | Ejecución de procedimientos | Recopilar evidencia suficiente y apropiada |
...
| Grupo CoreSystems Solutions | Auditado | Recibir retroalimentación constructiva y mejorar sus prácticas |

### 12.2 Stakeholders del Sistema AstraLog (Usuarios Finales)
...
|---|---|---|---|---|---|
| R-01 | Documentación incompleta del proyecto AstraLog. | Alta | Alto | Crítico | Solicitar toda la documentación disponible y registrar la ausencia de información como hallazgo de auditoría. |
...
- **Cooperación del equipo de desarrollo:** La disposición del equipo CoreSystems Solutions para proporcionar información, participar en entrevistas y facilitar el acceso a la documentación y evidencias del proyecto es esencial para el éxito de la auditoría.
...
- El Informe Final de Auditoría cubre el cumplimiento de todos los objetivos generales y específicos definidos para la auditoría del sistema AstraLog.
- El equipo de desarrollo CoreSystems Solutions ha elaborado el Plan de Acción Correctiva en respuesta a las observaciones y recomendaciones emitidas durante la auditoría.
...
- El equipo de desarrollo CoreSystems Solutions colaborará activamente con el Equipo Auditor, proporcionando la información, documentación y evidencias requeridas durante la ejecución de la auditoría.
...
- La documentación del proyecto AstraLog (Project Charter, documentación de requisitos, diagramas C4, diagramas UML, documentación técnica, repositorios y demás artefactos) es auténtica y representa fielmente el trabajo desarrollado por el equipo del proyecto.
- El Equipo Auditor cuenta con los conocimientos técnicos y metodológicos necesarios para evaluar el sistema AstraLog, desarrollado con una arquitectura monolítica modular utilizando Spring Boot, Angular, Flutter y MySQL.
- Los criterios de auditoría establecidos (ISO/IEC 12207, ISO/IEC 25010, CMMI-DEV y Checklist SDLC) son adecuados y aplicables al contexto académico del proyecto AstraLog.
- La auditoría se realizará sobre la versión final del sistema AstraLog, asumiendo que no se efectuarán cambios significativos en el software durante el proceso de auditoría.
...
- **Restricción de acceso al sistema:** La auditoría se realizará sobre la versión disponible del sistema AstraLog, por lo que las pruebas y verificaciones dependerán del acceso a los módulos, la documentación y las evidencias proporcionadas por el equipo de desarrollo.
- **Restricción documental:** La auditoría se limitará a la documentación, artefactos, repositorios y evidencias generadas durante el desarrollo del proyecto AstraLog por el equipo CoreSystems Solutions.
...
El presente Project Charter de Auditoría SDLC del Proyecto AstraLog – Solución Logística Centralizada ha sido revisado y se somete a la aprobación formal de las partes responsables que participan en el proceso de auditoría. La aprobación del presente documento representa la conformidad con los objetivos, alcance, metodología, cronograma, recursos y demás aspectos establecidos para la ejecución de la Auditoría del Ciclo de Vida del Desarrollo de Software (SDLC) del proyecto AstraLog. Asimismo, las partes involucradas manifiestan su compromiso de colaborar con el desarrollo de la auditoría, proporcionando la información, documentación y evidencias necesarias para el cumplimiento de los objetivos definidos en este Project Charter.

| Rol | Nombre | Fecha |
|---|---|---|
| Patrocinador — Universidad Peruana Unión | UPEU | 26/06/2026 (firma pendiente) |
| Auditor líder | MAMANI VARGAS, Anthony Kelman | 26/06/2026 (firma pendiente) |
| Representante del equipo auditado (Grupo CoreSystems Solutions) | APAZA YUCRA, Elvis Jesús | 26/06/2026 (firma pendiente) |
